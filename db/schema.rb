...
ActiveRecord::Schema.define(version: 2020_08_07_205447) do
  ...
  create_table "favorite_shows", force: :cascade do |t|
    ...
    t.bigint "show_id"
    t.bigint "user_id"
    t.index ["show_id"], name: "index_favorite_shows_on_show_id"
  ...
  create_table "shows", force: :cascade do |t|
    ...
    t.datetime "updated_at", precision: 6, null: false
    t.bigint "channel_id"
    t.boolean "favorite_show", default: false
  ...
  add_foreign_key "favorite_shows", "shows"
